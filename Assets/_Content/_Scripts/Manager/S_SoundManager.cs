...
public class SoundManager : MonoBehaviour
{
	...
	{
		m_audioMixer.SetFloat("Master", m_ssoSettings.DefaultVolumeDB);
        m_audioMixer.SetFloat("Music", m_ssoSettings.DefaultVolumeDB);
        m_audioMixer.SetFloat("SFX", m_ssoSettings.DefaultVolumeDB);
    }
