...
public class UISettings : UIWindow
{
	...
	private void InitializeSettings()
	{
        ...
        m_masterVolumeSlider.Initialize(m_ssoSettings.MinVolumeDB, m_ssoSettings.MaxVolumeDB, m_ssoSettings.DefaultVolumeDB);
        m_musicVolumeSlider.Initialize(m_ssoSettings.MinVolumeDB, m_ssoSettings.MaxVolumeDB, m_ssoSettings.DefaultVolumeDB);
        m_sfxVolumeSlider.Initialize(m_ssoSettings.MinVolumeDB, m_ssoSettings.MaxVolumeDB, m_ssoSettings.DefaultVolumeDB);
    }
